        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-b-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-maroon-500 to-maroon-700 text-white mb-4 shadow-lg shadow-maroon-600/30">
              {loginType === 'holder' ? <User size={40} /> : <Shield size={40} />}
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="rounded border-gray-300 text-maroon-600 focus:ring-maroon-500" />
                <span className="text-sm text-gray-600">Ingat saya</span>
              </label>
              <button type="button" className="text-sm text-maroon-600 hover:text-maroon-700 font-medium">
                Lupa kata laluan?
              </button>
            </div>
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <p className="text-sm text-gray-700">
              <span className="font-medium">Email:</span> {loginType === 'holder' ? 'lesen@demo.com' : 'public@demo.com'}
            </p>
            <p className="text-sm text-gray-700">
